...
export type SessionMessageRemoteCompactionItem = { type: string } & { [x: string]: JsonValue }
...
export type PluginInfo =
  ...
  | { id?: string; source: PluginSource; status: "failed"; error: string; ref?: string; tui: boolean }
...
export type SessionMessageCompactionRunning = {
  ...
  summary: string
  recent: string
  remote?: Array<SessionMessageRemoteCompactionItem>
}
...
export type SessionCompactionRemoteItem = {
  ...
  durable: { aggregateID: string; seq: number; version: 1 }
  location?: LocationRef
  data: { sessionID: string; reset: boolean; item: SessionMessageRemoteCompactionItem }
}
