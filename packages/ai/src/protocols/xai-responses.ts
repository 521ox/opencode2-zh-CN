...
const fromRequest = Effect.fn("XAIResponses.fromRequest")(function* (request: LLMRequest) {
  if (request.providerOptions?.contextManagement !== undefined || request.providerOptions?.compactThreshold !== undefined)
  ...
  return yield* decodeBody({ ...(yield* OpenResponses.fromRequestWithAdapter(request, adapter)), store: false })
})
