...
function MermanLayoutsStory(props: { context: Plugin.Context }) {
  ...
  props.context.keymap.layer(() => ({
    commands: [
      ...
      {
        bind: "left,k",
        title: i18n.t("feature.storybook.command.previousFixture"),
        group: i18n.t("feature.storybook.group"),
        run: () => move(-1),
      },
      {
        bind: "right,j",
        title: i18n.t("feature.storybook.command.nextFixture"),
        group: i18n.t("feature.storybook.group"),
        run: () => move(1),
      },
      {
        bind: "r",
        title: i18n.t("feature.storybook.command.resetFixture"),
        group: i18n.t("feature.storybook.group"),
        run: () => {
          setSelected(0)
  ...
  return (
    ...
    >
      ...
      <StoryFooter
        ...
        title={i18n.t("feature.storybook.footer.mermanLayouts")}
        details={[`${selected() + 1}/${fixtures.length}`, fixture().id, `${dimensions().width}x${dimensions().height}`]}
        controls={[
          { shortcut: "j/k or ←/→", label: i18n.t("feature.storybook.control.fixture") },
          { shortcut: "r", label: i18n.t("feature.storybook.control.reset") },
