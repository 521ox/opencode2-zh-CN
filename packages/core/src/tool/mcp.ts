...
export const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    // Tool notifications arrive in bursts and each read loads the complete catalog. Keep the bus
    // subscription eager, then debounce only the already-open sliding subscription.
