...
export interface Interface {
  ...
  readonly client: <D extends Rpc.Definition>(definition: D) => RpcClient<D, Rpc.SystemError, unknown>
...
const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const client = <D extends Rpc.Definition>(definition: D): RpcClient<D, Rpc.SystemError, unknown> => {
      const events = eventsFor(definition)
      ...
      } as RpcClient<D, Rpc.SystemError, unknown>
    }
